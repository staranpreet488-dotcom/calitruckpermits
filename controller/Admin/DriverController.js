...
const BASE_URL = process.env.NODE_ENV === 'production' ? process.env.LIVE_BASE_URL : (process.env.LOCAL_BASE_URL || 'http://localhost:2000');
...
const createPDF = async (html, filePath) => {
  const options = {
    format: "A4",
